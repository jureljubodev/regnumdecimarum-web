...
const ServicePage: React.FC<ServicePageProps> = ({ currentLang = "en" }) => {
  ...
  const servicesData = {
    ...
    interior: {
      ...
      bulletPoints: {
        ...
        hr: [
          "Usluge savjetovanja",
          "Montaža zidnih i podnih obloga",
          "Soboslikarstvo",
    ...
    transport: {
      ...
      description: {
        en: "We provide reliable, discreet, and premium private transport for clients who value punctuality, comfort, and professionalism. Whether it is airport transfers, business meetings, VIP guests, tourist rides, or private events, we deliver service at the highest level.",
        hr: "Nudimo pouzdan, diskretan i vrhunski privatni prijevoz za klijente koji cijene točnost, udobnost i profesionalnost. Bilo da se radi o transferima do zračne luke, poslovnim sastancima, VIP gostima, turističkim vožnjama ili privatnim eventima, osiguravamo uslugu na najvišoj razini.",
      },
      fullDescription: {
        en: "We provide reliable, discreet, and premium private transport for clients who value punctuality, comfort, and professionalism. Whether it is airport transfers, business meetings, VIP guests, tourist rides, or private events, we deliver service at the highest level.",
        hr: "Nudimo pouzdan, diskretan i vrhunski privatni prijevoz za klijente koji cijene točnost, udobnost i profesionalnost. Bilo da se radi o transferima do zračne luke, poslovnim sastancima, VIP gostima, turističkim vožnjama ili privatnim eventima, osiguravamo uslugu na najvišoj razini.",
      ...
      <section className={styles.servicePage}>
        <div className={styles.container}>
          <h1 className={styles.notFound}>
            {lang === "en" ? "Service not found" : "Usluga nije pronađena"}
          </h1>
  ...
  return (
    <section className={styles.servicePage}>
      <div className={styles.container}>
        <Link to="/" className={styles.backLink}>
          {lang === "en" ? "← Back to Home" : "← Nazad na Usluge"}
        </Link>
        ...
        <div className={styles.content}>
          {"bulletPoints" in service && service.bulletPoints ? (
            <div className={styles.features}>
              ...
              <ul>
                {service.bulletPoints[lang].map((point, index) => (
          ...
          <div className={styles.cta}>
            ...
            <a href={homeContactHref} className={styles.ctaButton}>
              {lang === "en" ? "Get in Touch" : "Kontaktirajte Nas"}
            </a>
          </div>
        </div>
      </div>
